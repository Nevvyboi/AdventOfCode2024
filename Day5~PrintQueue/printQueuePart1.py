...
totalValueOfMiddlePage : int = 0

for i, update in enumerate(updates, start=1):
    if isUpdateValid(update, graph):
        findLengthOfCorrectBookPages = len(update)
        totalValueOfMiddlePage += update[findLengthOfCorrectBookPages // 2]
    else:
        pass

print(totalValueOfMiddlePage)